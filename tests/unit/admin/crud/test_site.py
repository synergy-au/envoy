...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("", datetime.min, 4),
        ("", datetime.max, 0),
        ("", datetime(2022, 2, 3, 4, 5, 6, tzinfo=timezone.utc), 4),
        ("", datetime(2022, 2, 3, 5, 0, 0, tzinfo=timezone.utc), 3),
        ("", datetime(2022, 2, 3, 8, 5, 6, tzinfo=timezone.utc), 2),
        ("", datetime(2022, 2, 3, 10, 5, 6, tzinfo=timezone.utc), 1),
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            [1, 2, 3, 4],
            [[1, 2], [1], [1], []],
            [(2, 1, 1, 1, 1), (1, None, None, None, None), None, None],
        ),
        (0, 500, None, datetime(2022, 2, 3, 8, 5, 6, tzinfo=timezone.utc), [3, 4], [[1], []], [None, None]),
        (
            0,
            500,
            "",
        ...
        (1, 500, None, None, [2, 3, 4], [[1], [1], []], [(1, None, None, None, None), None, None]),
        (2, 500, None, None, [3, 4], [[1], []], [None, None]),
        (3, 500, None, None, [4], [[]], [None]),
        (4, 500, None, None, [], [], []),
