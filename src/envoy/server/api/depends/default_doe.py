...
class DefaultDoeDepends:
    ...
    storage_target_active_watts: Optional[Decimal]
    ...
    def __init__(
        ...
        self.storage_target_active_watts = storage_target_active_watts
    ...
    async def __call__(self, request: Request) -> None:
        request.state.default_doe = DefaultDoeConfiguration(
            ...
            storage_target_active_watts=self.storage_target_active_watts,
        )
