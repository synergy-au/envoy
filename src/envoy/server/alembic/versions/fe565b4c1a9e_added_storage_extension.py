...
def upgrade() -> None:
    ...
    op.add_column('archive_default_site_control', sa.Column('storage_target_active_watts', sa.DECIMAL(precision=16, scale=2), nullable=True))
    op.add_column('archive_dynamic_operating_envelope', sa.Column('storage_target_active_watts', sa.DECIMAL(precision=16, scale=2), nullable=True))
    ...
    op.add_column('default_site_control', sa.Column('storage_target_active_watts', sa.DECIMAL(precision=16, scale=2), nullable=True))
    op.add_column('dynamic_operating_envelope', sa.Column('storage_target_active_watts', sa.DECIMAL(precision=16, scale=2), nullable=True))
