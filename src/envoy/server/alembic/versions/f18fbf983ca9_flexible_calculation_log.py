...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        None, "dynamic_operating_envelope", "calculation_log", ["calculation_log_id"], ["calculation_log_id"]
    )
    op.create_index(
    ...
    op.create_foreign_key(
        None, "tariff_generated_rate", "calculation_log", ["calculation_log_id"], ["calculation_log_id"]
    )
    op.create_index(
