...
"""
    ...
    op.create_foreign_key(
        "dynamic_operating_envelope_site_control_group_id_fkey",
        "dynamic_operating_envelope",
        "site_control_group",
        ["site_control_group_id"],
        ["site_control_group_id"],
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(
        "dynamic_operating_envelope_site_control_group_id_fkey", "dynamic_operating_envelope", type_="foreignkey"
    )
    ...
    op.execute("UPDATE subscription SET resource_id = NULL WHERE resource_type = 2 AND resource_id = 1;")
    # ### end Alembic commands ###
